...
model_path = "/content/drive/MyDrive/Colab Notebooks/Deployment/Streamlit/model.pkl"
scaler_path = "/content/drive/MyDrive/Colab Notebooks/Deployment/Streamlit/scaler.pkl"
